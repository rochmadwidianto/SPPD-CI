...
class NotaSppd extends CI_Controller
{
    
    function __construct()
    {
        parent::__construct();
        $this->load->model('MTransNotaSppd');
        $this->load->library('form_validation');
    }

    public function index()
    {
        $kotatujuan = $this->MTransNotaSppd->get_all();

        $data = array(
            'kotatujuan_data' => $kotatujuan
        );

        $this->template->display('trans_nota_sppd/trans_nota_sppd_list', $data);
    }

    public function read($id) 
    {
        $row = $this->MTransNotaSppd->get_by_id($id);
        if ($row) {
            $data = array(
        		'kotaTujuanId' => $row->kotaTujuanId,
        		'kotaTujuanNama' => $row->kotaTujuanNama,
	        );
            $this->template->display('trans_nota_sppd/trans_nota_sppd_read', $data);
        } else {
    ...
    public function create() 
    {
        ...
        $this->template->display('trans_nota_sppd/trans_nota_sppd_form', $data);
    }
    ...
    public function create_action() 
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->MTransNotaSppd->insert($data);
    ...
    public function update_action() 
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->MTransNotaSppd->update($this->input->post('kotaTujuanId', TRUE), $data);
    ...
    public function excel()
    {
        ...
        $namaFile = "trans_nota_sppd.xls";
        $judul = "trans_nota_sppd";
        $tablehead = 0;
        $tablebody = 1;
        $nourut = 1;
        //penulisan header
	...
	foreach ($this->MTransNotaSppd->get_all() as $data) {
            $kolombody = 0;
...
/* End of file NotaSppd.php */
/* Location: ./application/controllers/NotaSppd.php */
