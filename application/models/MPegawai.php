...
class MPegawai extends CI_Model
{
    ...
    {
        $sql = "SELECT peg.`pegawaiId`, peg.`pegawaiNip`, peg.`pegawaiNama`, peg.`pegawaiPangkat`, peg.`pegawaiJabatan`, gol.`golonganKode`, gol.`golonganNama`
                FROM ref_pegawai AS peg, ref_golongan AS gol
                WHERE peg.`pegawaiGolonganId` = gol.`golonganId`";
	...
	$this->db->or_like('pegawaiJabatan', $q);
